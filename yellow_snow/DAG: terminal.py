...
query3 = """SELECT
            ...
            join consumer_stop_consignments as cscon on cscon.consignment_id = con.id
            join consumer_stops as cs on cscon.consumer_stop_id = cs.id
            join routes as r on r.id = cs.route_id
